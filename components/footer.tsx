...
export default function Footer() {
    return (
        <footer className="w-full text-white text-gray-700 bg-darkGray body-font">
            <div
                className="container mx-auto flex flex-col flex-wrap px-5 py-24 md:flex-no-wrap md:flex-row md:items-center lg:items-start">
                <div className="mx-auto w-64 flex-shrink-0 text-center md:mx-0 md:text-left">
                    <a className="flex items-center justify-center font-medium text-gray-900 title-font md:justify-start">
                        <svg className="h-5 w-auto fill-current text-gray-900" viewBox="0 0 202 69"
                    ...
                    <div className="mt-4">
                    <span className="mt-2 inline-flex justify-center sm:mt-0 sm:ml-auto sm:justify-start">
                        ...
                        <a className="ml-3 cursor-pointer text-gray-500 hover:text-gray-700">
                            <svg fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round"
                                 strokeWidth="2" className="h-5 w-5" viewBox="0 0 24 24">
                        ...
                        <a className="ml-3 cursor-pointer text-gray-500 hover:text-gray-700">
                            <svg fill="currentColor" stroke="currentColor" strokeLinecap="round"
                                 strokeLinejoin="round" strokeWidth="0" className="h-5 w-5" viewBox="0 0 24 24">
                                <path stroke="none"
                ...
                <div className="mt-10 -mb-10 flex flex-grow flex-wrap text-center md:mt-0 md:pl-20 md:text-left">
                    <div className="w-full px-4 md:w-1/2 lg:w-1/4">
                        <h2 className="mb-3 text-sm font-medium uppercase tracking-widest text-gray-900 title-font">About</h2>
                        <nav className="mb-10 list-none">
                            <ul>

                                <li className="mt-3">
                                    <a className="cursor-pointer text-gray-500 hover:text-gray-900">Company</a>
                                </li>
                                <li className="mt-3">
                                    <a className="cursor-pointer text-gray-500 hover:text-gray-900">Careers</a>
                                </li>
                                <li className="mt-3">
                                    <a className="cursor-pointer text-gray-500 hover:text-gray-900">Blog</a>
                                </li>
                            </ul>
                    ...
                    <div className="w-full px-4 md:w-1/2 lg:w-1/4">
                        <h2 className="mb-3 text-sm font-medium uppercase tracking-widest text-gray-900 title-font">Support</h2>
                        <nav className="mb-10 list-none">
                            <ul>
                                <li className="mt-3">
                                    <a className="cursor-pointer text-gray-500 hover:text-gray-900">Contact Support</a>
                                </li>
                                <li className="mt-3">
                                    <a className="cursor-pointer text-gray-500 hover:text-gray-900">Help Resources</a>
                                </li>
                                <li className="mt-3">
                                    <a className="cursor-pointer text-gray-500 hover:text-gray-900">Release Updates</a>
                                </li>
                            </ul>
                        </nav>
                    </div>
                    <div className="w-full px-4 md:w-1/2 lg:w-1/4">
                        <h2 className="mb-3 text-sm font-medium uppercase tracking-widest text-gray-900 title-font">Platform
                        </h2>
                        <nav className="mb-10 list-none">
                            <ul>

                                <li className="mt-3">
                                    <a className="cursor-pointer text-gray-500 hover:text-gray-900">Terms &amp; Privacy</a>
                                </li>
                                <li className="mt-3">
                                    <a className="cursor-pointer text-gray-500 hover:text-gray-900">Pricing</a>
                                </li>
                                <li className="mt-3">
                                    <a className="cursor-pointer text-gray-500 hover:text-gray-900">FAQ</a>
                                </li>
                            </ul>
                    ...
                    <div className="w-full px-4 md:w-1/2 lg:w-1/4">
                        <h2 className="mb-3 text-sm font-medium uppercase tracking-widest text-gray-900 title-font">Contact</h2>
                        <nav className="mb-10 list-none">
                            <ul>

                                <li className="mt-3">
                                    <a className="cursor-pointer text-gray-500 hover:text-gray-900">Send a Message</a>
                                </li>
                                <li className="mt-3">
                                    <a className="cursor-pointer text-gray-500 hover:text-gray-900">Request a Quote</a>
                                </li>
                                <li className="mt-3">
                                    <a className="cursor-pointer text-gray-500 hover:text-gray-900">+123-456-7890</a>
                                </li>
                            </ul>
            ...
            <div className="bg-gray-300">
                <div className="container mx-auto px-5 py-4">
                    <p className="text-sm capitalize text-gray-700 xl:text-center">© 2020 All rights reserved </p>
                </div>
            </div>
        </footer>
    )
